    ...
    <body>
        ...
        <div class="w3-main" style="margin-left:340px;margin-right:40px">
            ...
            <div class="w3-container" style="margin-top:80px" id="showcase">
                ...
                //message to show that the league has been created successfully; else throw an error
                ...
                $sql5 = "INSERT INTO players (leagueid, userID, username)
                VALUES ('$leagueidplayerr', '$useridplayerr', '" .
